...
def combine_data(input_path):
	...
	for file in tqdm(file_list):
		...
		data = pd.read_csv(filename, converters = {"post_id": str, "post_name": str, "post_message": str, "post_picture": str, "post_link": str },  lineterminator = '\n')
...
def select_posts(data, output_path):
	...
	immigration_posts.to_csv(output_path + "immigration_posts_event3.csv")
	...
	none_posts.to_csv(output_path + "immigration_none_posts_event3.csv")


def main():
	data = "/home3/r05322021/Desktop/FB Data/posts_rawdata/immigration_event3/immigration_event3.csv"
